      ...
      <section className="min-h-[85vh] flex flex-col justify-center items-center text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex gap-2">
            <a href="https://github.com/elad9219" target="_blank" rel="noreferrer" className="p-3 bg-[#1c1c1e] border border-white/10 rounded-full hover:bg-white/5 transition-all duration-200 flex items-center justify-center text-neutral-400 hover:text-white">
